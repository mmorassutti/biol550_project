...
](https://github.com/mmorassutti/biol550_project/blob/ef8ae623a0b93843b90c246fc2ff551a83d6ed3b/Figure5_Chronogram.png)**Figure 5.** A chronogram estimated using the cladogram seen in Figure 3. Time calibration was estimated using penalized likelihood and four fossils. Labeled points correspond with the following fossils: A - _Palaeosciurus goti_, B - _Miospermophilus_, C - _Marmota marmota_, D - _Marmota bobak_.
